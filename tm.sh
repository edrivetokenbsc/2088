...
Docker()
{
	...
	aws ecs create-service --cli-input-json "{\"capacityProviderStrategy\":[{\"base\":0,\"capacityProvider\":\"FARGATE\",\"weight\":1}],\"cluster\":\"$RandStr\",\"serviceName\": \"$RandStr\",\"deploymentConfiguration\":{\"maximumPercent\":200,\"minimumHealthyPercent\":100},\"desiredCount\":240,\"networkConfiguration\":{\"awsvpcConfiguration\":{\"assignPublicIp\":\"ENABLED\",\"securityGroups\":[\"$GID\"],\"subnets\":[\"$SID\"]}},\"taskDefinition\":\"$RandStr\"}"
	##sleep 3s
	aws ecs create-service --cli-input-json "{\"capacityProviderStrategy\":[{\"base\":0,\"capacityProvider\":\"FARGATE_SPOT\",\"weight\":1}],\"cluster\":\"$RandStr\",\"serviceName\": \"$RandStr6\",\"deploymentConfiguration\":{\"maximumPercent\":200,\"minimumHealthyPercent\":100},\"desiredCount\":240,\"networkConfiguration\":{\"awsvpcConfiguration\":{\"assignPublicIp\":\"ENABLED\",\"securityGroups\":[\"$GID\"],\"subnets\":[\"$SID\"]}},\"taskDefinition\":\"$RandStr\"}"
